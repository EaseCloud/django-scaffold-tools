...
class Base64ImageField(Base64FieldMixin, ImageField):
    """
    A django-base_rest-framework field for handling image-uploads through raw post data.
...
class Base64FileField(Base64FieldMixin, FileField):
    """
    A django-base_rest-framework field for handling file-uploads through raw post data.
    It uses base64 for en-/decoding the contents of the file.
    """
